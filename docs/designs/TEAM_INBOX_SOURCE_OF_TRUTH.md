...
| List/detail/metrics/actions and media presentation | `communications.team_inbox_projection` | Normalizes filters, sort and pagination, computes KPIs, unread and action eligibility, and resolves safe inline-image versus download-only media presentation |
...
- Information owner: `communications.team_inbox_projection` returns the list
  ...
  presentation for authorized media content.
