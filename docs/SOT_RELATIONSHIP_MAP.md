...
| `communications.team_inbox_contact_resolution` | canonical multi-endpoint Customer identity aggregation | `resolver` | canonical party contact facts ← `party.registry`<br>customer identity scope ← `customer.identity_scope`<br>conversation contact route ← `communications.team_inbox_threads`<br>conversation participant relationship ← `communications.team_inbox_participants` | `owner_managed` | `complete` | customer experience platform | `docs/designs/TEAM_INBOX_SOURCE_OF_TRUTH.md`<br>`docs/runbooks/TEAM_INBOX_SUBSCRIBER_LINK_REPAIR.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/UI_INFORMATION_AND_ACTION_STANDARD.md`<br>`docs/designs/INBOX_CONVERSATION_PARTICIPANTS.md`<br>`tests/test_team_inbox_contact_links.py`<br>`tests/test_team_inbox_admin_contact_links.py`<br>`tests/test_repair_team_inbox_subscriber_links.py`<br>`tests/architecture/test_team_inbox_sot_contracts.py` |
| `communications.team_inbox_contact_resolution` | automatic conversation Customer association and repair | `projection_writer` | canonical party contact facts ← `party.registry`<br>customer identity scope ← `customer.identity_scope`<br>conversation contact route ← `communications.team_inbox_threads`<br>conversation participant relationship ← `communications.team_inbox_participants` | `owner_managed` | `complete` | customer experience platform | `docs/designs/TEAM_INBOX_SOURCE_OF_TRUTH.md`<br>`docs/runbooks/TEAM_INBOX_SUBSCRIBER_LINK_REPAIR.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/UI_INFORMATION_AND_ACTION_STANDARD.md`<br>`docs/designs/INBOX_CONVERSATION_PARTICIPANTS.md`<br>`tests/test_team_inbox_contact_links.py`<br>`tests/test_team_inbox_admin_contact_links.py`<br>`tests/test_repair_team_inbox_subscriber_links.py`<br>`tests/architecture/test_team_inbox_sot_contracts.py` |
...
| `communications.team_inbox_routing` | routing assignment and escalation policy | `policy` | conversation routing facts ← `communications.team_inbox_threads`<br>WhatsApp customer-service window ← `communications.team_inbox_reply_window`<br>operational escalation policy ← `operations.sla_escalation`<br>operator authorization ← `auth.permission_gate`<br>validated AI intake destination metadata ← `ai.intake`<br>active AI conversation ownership ← `ai.intake`<br>successful staff session issuance ← `app_sessions.auth`<br>authenticated visible Inbox activity ← `app_sessions.auth`<br>active staff principal ← `auth.staff_provisioning`<br>agent capacity configuration ← `control.settings_spec`<br>agent capacity setting persistence ← `control.domain_settings` | `owner_managed` | `complete` | customer experience platform | `docs/designs/TEAM_INBOX_SOURCE_OF_TRUTH.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/UI_INFORMATION_AND_ACTION_STANDARD.md`<br>`tests/test_admin_inbox_slice4_workflows.py`<br>`tests/test_auth_flow.py`<br>`tests/test_team_inbox_assignment.py`<br>`tests/test_team_inbox_commands.py`<br>`tests/test_team_inbox_fifo_queue.py`<br>`tests/test_team_inbox_queue_notifications.py`<br>`tests/integration/test_team_inbox_queue_concurrency.py` |
| `communications.team_inbox_routing` | routing assignment and escalation transitions | `command_writer` | conversation routing facts ← `communications.team_inbox_threads`<br>WhatsApp customer-service window ← `communications.team_inbox_reply_window`<br>operational escalation policy ← `operations.sla_escalation`<br>operator authorization ← `auth.permission_gate`<br>validated AI intake destination metadata ← `ai.intake`<br>active AI conversation ownership ← `ai.intake`<br>successful staff session issuance ← `app_sessions.auth`<br>authenticated visible Inbox activity ← `app_sessions.auth`<br>active staff principal ← `auth.staff_provisioning`<br>agent capacity configuration ← `control.settings_spec`<br>agent capacity setting persistence ← `control.domain_settings` | `owner_managed` | `complete` | customer experience platform | `docs/designs/TEAM_INBOX_SOURCE_OF_TRUTH.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/UI_INFORMATION_AND_ACTION_STANDARD.md`<br>`tests/test_admin_inbox_slice4_workflows.py`<br>`tests/test_auth_flow.py`<br>`tests/test_team_inbox_assignment.py`<br>`tests/test_team_inbox_commands.py`<br>`tests/test_team_inbox_fifo_queue.py`<br>`tests/test_team_inbox_queue_notifications.py`<br>`tests/integration/test_team_inbox_queue_concurrency.py` |
| `communications.team_inbox_routing` | immutable routing assignment and escalation evidence | `authoritative_record` | conversation routing facts ← `communications.team_inbox_threads`<br>WhatsApp customer-service window ← `communications.team_inbox_reply_window`<br>operational escalation policy ← `operations.sla_escalation`<br>operator authorization ← `auth.permission_gate`<br>validated AI intake destination metadata ← `ai.intake`<br>active AI conversation ownership ← `ai.intake`<br>successful staff session issuance ← `app_sessions.auth`<br>authenticated visible Inbox activity ← `app_sessions.auth`<br>active staff principal ← `auth.staff_provisioning`<br>agent capacity configuration ← `control.settings_spec`<br>agent capacity setting persistence ← `control.domain_settings` | `owner_managed` | `complete` | customer experience platform | `docs/designs/TEAM_INBOX_SOURCE_OF_TRUTH.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/UI_INFORMATION_AND_ACTION_STANDARD.md`<br>`tests/test_admin_inbox_slice4_workflows.py`<br>`tests/test_auth_flow.py`<br>`tests/test_team_inbox_assignment.py`<br>`tests/test_team_inbox_commands.py`<br>`tests/test_team_inbox_fifo_queue.py`<br>`tests/test_team_inbox_queue_notifications.py`<br>`tests/integration/test_team_inbox_queue_concurrency.py` |
| `communications.team_inbox_routing` | durable FIFO queue admission and promotion | `command_writer` | conversation routing facts ← `communications.team_inbox_threads`<br>WhatsApp customer-service window ← `communications.team_inbox_reply_window`<br>operational escalation policy ← `operations.sla_escalation`<br>operator authorization ← `auth.permission_gate`<br>validated AI intake destination metadata ← `ai.intake`<br>active AI conversation ownership ← `ai.intake`<br>successful staff session issuance ← `app_sessions.auth`<br>authenticated visible Inbox activity ← `app_sessions.auth`<br>active staff principal ← `auth.staff_provisioning`<br>agent capacity configuration ← `control.settings_spec`<br>agent capacity setting persistence ← `control.domain_settings` | `owner_managed` | `complete` | customer experience platform | `docs/designs/TEAM_INBOX_SOURCE_OF_TRUTH.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/UI_INFORMATION_AND_ACTION_STANDARD.md`<br>`tests/test_admin_inbox_slice4_workflows.py`<br>`tests/test_auth_flow.py`<br>`tests/test_team_inbox_assignment.py`<br>`tests/test_team_inbox_commands.py`<br>`tests/test_team_inbox_fifo_queue.py`<br>`tests/test_team_inbox_queue_notifications.py`<br>`tests/integration/test_team_inbox_queue_concurrency.py` |
| `communications.team_inbox_routing` | strict per-team FIFO head serialization | `policy` | conversation routing facts ← `communications.team_inbox_threads`<br>WhatsApp customer-service window ← `communications.team_inbox_reply_window`<br>operational escalation policy ← `operations.sla_escalation`<br>operator authorization ← `auth.permission_gate`<br>validated AI intake destination metadata ← `ai.intake`<br>active AI conversation ownership ← `ai.intake`<br>successful staff session issuance ← `app_sessions.auth`<br>authenticated visible Inbox activity ← `app_sessions.auth`<br>active staff principal ← `auth.staff_provisioning`<br>agent capacity configuration ← `control.settings_spec`<br>agent capacity setting persistence ← `control.domain_settings` | `owner_managed` | `complete` | customer experience platform | `docs/designs/TEAM_INBOX_SOURCE_OF_TRUTH.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/UI_INFORMATION_AND_ACTION_STANDARD.md`<br>`tests/test_admin_inbox_slice4_workflows.py`<br>`tests/test_auth_flow.py`<br>`tests/test_team_inbox_assignment.py`<br>`tests/test_team_inbox_commands.py`<br>`tests/test_team_inbox_fifo_queue.py`<br>`tests/test_team_inbox_queue_notifications.py`<br>`tests/integration/test_team_inbox_queue_concurrency.py` |
| `communications.team_inbox_routing` | current customer-visible queue position projection | `resolver` | conversation routing facts ← `communications.team_inbox_threads`<br>WhatsApp customer-service window ← `communications.team_inbox_reply_window`<br>operational escalation policy ← `operations.sla_escalation`<br>operator authorization ← `auth.permission_gate`<br>validated AI intake destination metadata ← `ai.intake`<br>active AI conversation ownership ← `ai.intake`<br>successful staff session issuance ← `app_sessions.auth`<br>authenticated visible Inbox activity ← `app_sessions.auth`<br>active staff principal ← `auth.staff_provisioning`<br>agent capacity configuration ← `control.settings_spec`<br>agent capacity setting persistence ← `control.domain_settings` | `owner_managed` | `complete` | customer experience platform | `docs/designs/TEAM_INBOX_SOURCE_OF_TRUTH.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/UI_INFORMATION_AND_ACTION_STANDARD.md`<br>`tests/test_admin_inbox_slice4_workflows.py`<br>`tests/test_auth_flow.py`<br>`tests/test_team_inbox_assignment.py`<br>`tests/test_team_inbox_commands.py`<br>`tests/test_team_inbox_fifo_queue.py`<br>`tests/test_team_inbox_queue_notifications.py`<br>`tests/integration/test_team_inbox_queue_concurrency.py` |
| `communications.team_inbox_routing` | global per-agent active assignment capacity enforcement | `policy` | conversation routing facts ← `communications.team_inbox_threads`<br>WhatsApp customer-service window ← `communications.team_inbox_reply_window`<br>operational escalation policy ← `operations.sla_escalation`<br>operator authorization ← `auth.permission_gate`<br>validated AI intake destination metadata ← `ai.intake`<br>active AI conversation ownership ← `ai.intake`<br>successful staff session issuance ← `app_sessions.auth`<br>authenticated visible Inbox activity ← `app_sessions.auth`<br>active staff principal ← `auth.staff_provisioning`<br>agent capacity configuration ← `control.settings_spec`<br>agent capacity setting persistence ← `control.domain_settings` | `owner_managed` | `complete` | customer experience platform | `docs/designs/TEAM_INBOX_SOURCE_OF_TRUTH.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/UI_INFORMATION_AND_ACTION_STANDARD.md`<br>`tests/test_admin_inbox_slice4_workflows.py`<br>`tests/test_auth_flow.py`<br>`tests/test_team_inbox_assignment.py`<br>`tests/test_team_inbox_commands.py`<br>`tests/test_team_inbox_fifo_queue.py`<br>`tests/test_team_inbox_queue_notifications.py`<br>`tests/integration/test_team_inbox_queue_concurrency.py` |
| `communications.team_inbox_routing` | global Inbox capacity configuration coordination | `command_writer` | conversation routing facts ← `communications.team_inbox_threads`<br>WhatsApp customer-service window ← `communications.team_inbox_reply_window`<br>operational escalation policy ← `operations.sla_escalation`<br>operator authorization ← `auth.permission_gate`<br>validated AI intake destination metadata ← `ai.intake`<br>active AI conversation ownership ← `ai.intake`<br>successful staff session issuance ← `app_sessions.auth`<br>authenticated visible Inbox activity ← `app_sessions.auth`<br>active staff principal ← `auth.staff_provisioning`<br>agent capacity configuration ← `control.settings_spec`<br>agent capacity setting persistence ← `control.domain_settings` | `owner_managed` | `complete` | customer experience platform | `docs/designs/TEAM_INBOX_SOURCE_OF_TRUTH.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/UI_INFORMATION_AND_ACTION_STANDARD.md`<br>`tests/test_admin_inbox_slice4_workflows.py`<br>`tests/test_auth_flow.py`<br>`tests/test_team_inbox_assignment.py`<br>`tests/test_team_inbox_commands.py`<br>`tests/test_team_inbox_fifo_queue.py`<br>`tests/test_team_inbox_queue_notifications.py`<br>`tests/integration/test_team_inbox_queue_concurrency.py` |
| `communications.team_inbox_routing` | expired WhatsApp assignment and FIFO release transitions | `command_writer` | conversation routing facts ← `communications.team_inbox_threads`<br>WhatsApp customer-service window ← `communications.team_inbox_reply_window`<br>operational escalation policy ← `operations.sla_escalation`<br>operator authorization ← `auth.permission_gate`<br>validated AI intake destination metadata ← `ai.intake`<br>active AI conversation ownership ← `ai.intake`<br>successful staff session issuance ← `app_sessions.auth`<br>authenticated visible Inbox activity ← `app_sessions.auth`<br>active staff principal ← `auth.staff_provisioning`<br>agent capacity configuration ← `control.settings_spec`<br>agent capacity setting persistence ← `control.domain_settings` | `owner_managed` | `complete` | customer experience platform | `docs/designs/TEAM_INBOX_SOURCE_OF_TRUTH.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/UI_INFORMATION_AND_ACTION_STANDARD.md`<br>`tests/test_admin_inbox_slice4_workflows.py`<br>`tests/test_auth_flow.py`<br>`tests/test_team_inbox_assignment.py`<br>`tests/test_team_inbox_commands.py`<br>`tests/test_team_inbox_fifo_queue.py`<br>`tests/test_team_inbox_queue_notifications.py`<br>`tests/integration/test_team_inbox_queue_concurrency.py` |
| `communications.team_inbox_routing` | durable per-team round-robin cursor | `authoritative_record` | conversation routing facts ← `communications.team_inbox_threads`<br>WhatsApp customer-service window ← `communications.team_inbox_reply_window`<br>operational escalation policy ← `operations.sla_escalation`<br>operator authorization ← `auth.permission_gate`<br>validated AI intake destination metadata ← `ai.intake`<br>active AI conversation ownership ← `ai.intake`<br>successful staff session issuance ← `app_sessions.auth`<br>authenticated visible Inbox activity ← `app_sessions.auth`<br>active staff principal ← `auth.staff_provisioning`<br>agent capacity configuration ← `control.settings_spec`<br>agent capacity setting persistence ← `control.domain_settings` | `owner_managed` | `complete` | customer experience platform | `docs/designs/TEAM_INBOX_SOURCE_OF_TRUTH.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/UI_INFORMATION_AND_ACTION_STANDARD.md`<br>`tests/test_admin_inbox_slice4_workflows.py`<br>`tests/test_auth_flow.py`<br>`tests/test_team_inbox_assignment.py`<br>`tests/test_team_inbox_commands.py`<br>`tests/test_team_inbox_fifo_queue.py`<br>`tests/test_team_inbox_queue_notifications.py`<br>`tests/integration/test_team_inbox_queue_concurrency.py` |
| `communications.team_inbox_routing` | customer-visible FIFO queue notification evidence | `command_writer` | conversation routing facts ← `communications.team_inbox_threads`<br>WhatsApp customer-service window ← `communications.team_inbox_reply_window`<br>operational escalation policy ← `operations.sla_escalation`<br>operator authorization ← `auth.permission_gate`<br>validated AI intake destination metadata ← `ai.intake`<br>active AI conversation ownership ← `ai.intake`<br>successful staff session issuance ← `app_sessions.auth`<br>authenticated visible Inbox activity ← `app_sessions.auth`<br>active staff principal ← `auth.staff_provisioning`<br>agent capacity configuration ← `control.settings_spec`<br>agent capacity setting persistence ← `control.domain_settings` | `owner_managed` | `complete` | customer experience platform | `docs/designs/TEAM_INBOX_SOURCE_OF_TRUTH.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/UI_INFORMATION_AND_ACTION_STANDARD.md`<br>`tests/test_admin_inbox_slice4_workflows.py`<br>`tests/test_auth_flow.py`<br>`tests/test_team_inbox_assignment.py`<br>`tests/test_team_inbox_commands.py`<br>`tests/test_team_inbox_fifo_queue.py`<br>`tests/test_team_inbox_queue_notifications.py`<br>`tests/integration/test_team_inbox_queue_concurrency.py` |
| `communications.team_inbox_routing` | current agent presence state and freshness | `authoritative_record` | conversation routing facts ← `communications.team_inbox_threads`<br>WhatsApp customer-service window ← `communications.team_inbox_reply_window`<br>operational escalation policy ← `operations.sla_escalation`<br>operator authorization ← `auth.permission_gate`<br>validated AI intake destination metadata ← `ai.intake`<br>active AI conversation ownership ← `ai.intake`<br>successful staff session issuance ← `app_sessions.auth`<br>authenticated visible Inbox activity ← `app_sessions.auth`<br>active staff principal ← `auth.staff_provisioning`<br>agent capacity configuration ← `control.settings_spec`<br>agent capacity setting persistence ← `control.domain_settings` | `owner_managed` | `complete` | customer experience platform | `docs/designs/TEAM_INBOX_SOURCE_OF_TRUTH.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/UI_INFORMATION_AND_ACTION_STANDARD.md`<br>`tests/test_admin_inbox_slice4_workflows.py`<br>`tests/test_auth_flow.py`<br>`tests/test_team_inbox_assignment.py`<br>`tests/test_team_inbox_commands.py`<br>`tests/test_team_inbox_fifo_queue.py`<br>`tests/test_team_inbox_queue_notifications.py`<br>`tests/integration/test_team_inbox_queue_concurrency.py` |
| `communications.team_inbox_routing` | agent presence transitions | `command_writer` | conversation routing facts ← `communications.team_inbox_threads`<br>WhatsApp customer-service window ← `communications.team_inbox_reply_window`<br>operational escalation policy ← `operations.sla_escalation`<br>operator authorization ← `auth.permission_gate`<br>validated AI intake destination metadata ← `ai.intake`<br>active AI conversation ownership ← `ai.intake`<br>successful staff session issuance ← `app_sessions.auth`<br>authenticated visible Inbox activity ← `app_sessions.auth`<br>active staff principal ← `auth.staff_provisioning`<br>agent capacity configuration ← `control.settings_spec`<br>agent capacity setting persistence ← `control.domain_settings` | `owner_managed` | `complete` | customer experience platform | `docs/designs/TEAM_INBOX_SOURCE_OF_TRUTH.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/UI_INFORMATION_AND_ACTION_STANDARD.md`<br>`tests/test_admin_inbox_slice4_workflows.py`<br>`tests/test_auth_flow.py`<br>`tests/test_team_inbox_assignment.py`<br>`tests/test_team_inbox_commands.py`<br>`tests/test_team_inbox_fifo_queue.py`<br>`tests/test_team_inbox_queue_notifications.py`<br>`tests/integration/test_team_inbox_queue_concurrency.py` |
| `communications.team_inbox_routing` | immutable agent presence transition evidence | `authoritative_record` | conversation routing facts ← `communications.team_inbox_threads`<br>WhatsApp customer-service window ← `communications.team_inbox_reply_window`<br>operational escalation policy ← `operations.sla_escalation`<br>operator authorization ← `auth.permission_gate`<br>validated AI intake destination metadata ← `ai.intake`<br>active AI conversation ownership ← `ai.intake`<br>successful staff session issuance ← `app_sessions.auth`<br>authenticated visible Inbox activity ← `app_sessions.auth`<br>active staff principal ← `auth.staff_provisioning`<br>agent capacity configuration ← `control.settings_spec`<br>agent capacity setting persistence ← `control.domain_settings` | `owner_managed` | `complete` | customer experience platform | `docs/designs/TEAM_INBOX_SOURCE_OF_TRUTH.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/UI_INFORMATION_AND_ACTION_STANDARD.md`<br>`tests/test_admin_inbox_slice4_workflows.py`<br>`tests/test_auth_flow.py`<br>`tests/test_team_inbox_assignment.py`<br>`tests/test_team_inbox_commands.py`<br>`tests/test_team_inbox_fifo_queue.py`<br>`tests/test_team_inbox_queue_notifications.py`<br>`tests/integration/test_team_inbox_queue_concurrency.py` |
...
| `communications.team_inbox_maintenance` | scheduled Inbox projection maintenance and repair | `reconciler` | current Inbox projection ← `communications.team_inbox_projection`<br>canonical conversation identity ← `communications.team_inbox_threads`<br>outbound intent state ← `communications.team_inbox_outbound_intents`<br>AI intake recovery state ← `ai.intake`<br>normal human routing and FIFO state ← `communications.team_inbox_routing`<br>expired WhatsApp lifecycle worklist ← `communications.team_inbox_reply_window`<br>verified WhatsApp webhook repair evidence ← `integration.inbox`<br>Meta contact profile observation ← `integration.runtime` | `owner_managed` | `complete` | customer experience platform | `docs/designs/TEAM_INBOX_SOURCE_OF_TRUTH.md`<br>`docs/runbooks/TEAM_INBOX_EXPIRED_WHATSAPP_ASSIGNMENT_REPAIR.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`tests/test_team_inbox_whatsapp_expiry.py`<br>`tests/integration/test_team_inbox_queue_concurrency.py` |
| `communications.team_inbox_maintenance` | expired WhatsApp routing-state convergence and historical repair | `reconciler` | current Inbox projection ← `communications.team_inbox_projection`<br>canonical conversation identity ← `communications.team_inbox_threads`<br>outbound intent state ← `communications.team_inbox_outbound_intents`<br>AI intake recovery state ← `ai.intake`<br>normal human routing and FIFO state ← `communications.team_inbox_routing`<br>expired WhatsApp lifecycle worklist ← `communications.team_inbox_reply_window`<br>verified WhatsApp webhook repair evidence ← `integration.inbox`<br>Meta contact profile observation ← `integration.runtime` | `owner_managed` | `complete` | customer experience platform | `docs/designs/TEAM_INBOX_SOURCE_OF_TRUTH.md`<br>`docs/runbooks/TEAM_INBOX_EXPIRED_WHATSAPP_ASSIGNMENT_REPAIR.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`tests/test_team_inbox_whatsapp_expiry.py`<br>`tests/integration/test_team_inbox_queue_concurrency.py` |
...
| `sales.meta_lead_customer_match` | pre-capture Meta Lead canonical Customer decision | `application_coordinator` | verified Meta Lead contact observations ← `integration.inbox`<br>canonical Customer identity decision ← `customer.identity_scope` | `coordinator_managed` | `native` | sales operations | `docs/designs/MARKETING_SALES_SOT.md`<br>`docs/designs/SALES_TO_SERVICE_LIFECYCLE_SOT.md`<br>`tests/test_meta_lead_ads.py` |
| `sales.meta_lead_customer_match` | Meta Lead customer-match projection | `projection_writer` | captured Meta Lead contact observations ← `sales.capture`<br>verified customer contact identity ← `party.registry` | `coordinator_managed` | `native` | sales operations | `docs/designs/MARKETING_SALES_SOT.md`<br>`docs/designs/SALES_TO_SERVICE_LIFECYCLE_SOT.md`<br>`tests/test_meta_lead_ads.py` |
...
| `sales.lead_intake` | pre-creation canonical Customer identity recheck | `application_coordinator` | canonical Lead intake invitation ← `sales.lead_intake`<br>canonical Customer identity decision ← `communications.team_inbox_contact_resolution`<br>canonical unknown Inbox conversation state ← `communications.team_inbox_processing` | `coordinator_managed` | `complete` | sales operations | `docs/designs/INBOX_LEAD_INTAKE.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/PARTY_CUSTOMER_LIFECYCLE.md`<br>`tests/test_lead_intake.py`<br>`tests/test_web_lead_intake.py`<br>`tests/architecture/test_lead_intake_boundary.py` |
...
9. The contracted `communications.team_inbox_*` owner family replaces the old
   ...
   The same owner now aggregates reviewed Inbox links, the Customer identity
   index, direct Subscriber fields, SubscriberContact, SubscriberChannel, and
   verified Party contact points before writing a unique automatic match to
   `InboxConversation.subscriber_id`. Provider display names are observations:
   they may break a tie among multiple exact phone/email candidates but cannot
   veto one unique candidate. Messenger and Instagram identity is isolated by
   channel, provider, provider account, and external subject. Representative
   contact points remain on the representative Party while the conversation may
   resolve operationally to the represented Customer Party.
