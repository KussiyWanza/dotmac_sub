...
| `financial.payment_intent_management` | customer payment-intent history projection | `resolver` | canonical account payment intents ← `financial.topup_intents` | `coordinator_managed` | `complete` | finance operations | `docs/SOT_RELATIONSHIP_MAP.md`<br>`tests/test_payment_intent_management.py` |
| `financial.payment_intent_management` | unsubmitted direct-transfer intent cancellation | `command_writer` | canonical account payment intents ← `financial.topup_intents`<br>typed payment-intent cancellation evidence ← `financial.payment_intent_management` | `coordinator_managed` | `complete` | finance operations | `docs/SOT_RELATIONSHIP_MAP.md`<br>`tests/test_payment_intent_management.py` |
