...
| `sales.customer_quote_linkage` | customer-to-dedicated-Quote-Lead resolution | `resolver` | canonical customer account state ← `customer.accounts` | `participant` | `native` | sales operations | `docs/designs/SALES_TO_SERVICE_LIFECYCLE_SOT.md`<br>`tests/test_web_sales_quote_authoring.py` |
