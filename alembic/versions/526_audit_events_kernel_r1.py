...
Revision ID: 526_audit_events_kernel_r1
Revises: 525_inbox_self_assign_permission
...
revision: str = "526_audit_events_kernel_r1"
down_revision: str | None = "525_inbox_self_assign_permission"
