...
Revision ID: 527_credential_party_binding_additive
Revises: 526_audit_events_kernel_r1
...
revision: str = "527_credential_party_binding_additive"
down_revision: str | None = "526_audit_events_kernel_r1"
