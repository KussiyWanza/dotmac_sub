...
def load_quote_document_snapshot(value: object) -> QuoteDocumentSnapshot:
    ...
    try:
        ...
        raw_paystack_url = payment_value["paystack_url"]
        if raw_paystack_url is not None and not isinstance(raw_paystack_url, str):
            raise TypeError("Paystack URL must be a string or null")
...
<div class='payment-grid'><div class='{bank_card_class}'><h3>Bank Transfer</h3>
